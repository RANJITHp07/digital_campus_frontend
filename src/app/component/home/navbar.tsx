...
function Navbar() {
  ...
  return (
    ...
    <nav className='flex justify-between items-center relative '>
        <Link href='/'><Image src={'/Logo.png'} width={50} height={50} alt='logo' className='m-2 mx-4 cursor-pointer'/></Link>
        <div className='md:flex hidden'>
            <Link href='/' className='text  text-[#194866] hover:border-b-4 cursor-pointer border-[#194866] rounded'>Home</Link>
            <Link href='#about' className='mx-5 text text-[#194866]  hover:border-b-4 cursor-pointer border-[#194866] rounded'>About</Link>
            <Link href='#services' className='text  text-[#194866]  hover:border-b-4 cursor-pointer border-[#194866] rounded'>Services</Link>
        </div>
        <div className='hidden md:block'>
            <a href='/login' className='bg-[#194866] cursor-pointer text-white px-4  py-2 rounded-md mx-3'>Login</a>
        </div>
        <div className='md:hidden'>
           <ListIcon className='text-3xl mx-3 text-[#194866]' onClick={()=>setopen(!open)}/>
        </div>
        {
          open && 
