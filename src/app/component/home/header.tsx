    ...
    <div>
        <div className="md:flex items-center min-h-[18rem] mt-7">
            <div className="md:w-7/12">
                <p className=' heading font-semibold mt-9 text-[72px] lg:text-[80px] ml-5 md:ml-8 xm:ml-16 lg:ml-20 text-[#194866]  '>Online learning ,<br/> delivered your way</p>
            </div>
        ...
        <div className='flex lg:justify-end items-center relative' id='about'>
          ...
          <p className='heading font-semibold text-[50px]  xl:text-[55px]  xl:mr-7 text-white'>Digital Campus puts the<br/> power of eLearning<br/> in your hands</p>
          <p className=' text text-white mt-12'>At Digital Campus, our mission is to empower educators<br/> to improve our world with our open source eLearning software.</p>
          <p className=' text text-white xl:mr-6 mt-8 mb-5'>Flexible, secure, and customisable for any online teaching or training initiative,<br/> Digital Campus gives you the freedom to create an eLearning platform<br/> that best meets your needs.</p>
          </div>
        </div>
        </div>
    </div>
